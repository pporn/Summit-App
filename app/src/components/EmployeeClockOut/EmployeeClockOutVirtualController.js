...
function authEmployee(payload, callback, onClockedOut) {
    ...
    firebase.auth().signInWithEmailAndPassword(email, password)
        ...
        .then((user) => {
            ...
            if(returnVal.error) {
                callback(returnVal, onClockedOut);
...
function onAuthed(res, callback) {
    ...
    const api = 'https://us-central1-summit-app-6f288.cloudfunctions.net/employeeClockOut';
...
function clockOut(payload, callback) {
